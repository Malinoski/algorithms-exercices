...
km_per_liter = 12
t = float(input("Tempo gasto na viajem: "))
v = float(input("Velociadade media: "))

# Distance
d = t * v
print("Distância percorrida: ", d)

# Liter
used_liter = d/km_per_liter
print("Quantidade de litros de combustível utilizada na viagem: ", round(used_liter, 3))
